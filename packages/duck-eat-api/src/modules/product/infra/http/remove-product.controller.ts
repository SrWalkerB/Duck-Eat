...
import { removeProductDto, removeProductResponse } from "../../application/dto/remove-product.dto";
...
export const removeProductController: FastifyPluginAsyncZod = async (app) => {
    app.delete(
        ...
        async (request, reply) => {
            ...
            const removeProductUseCase = new RemoveProductUseCase(new PrismaProductRepository());
