...
import type { Company, CompanySession } from "@/generated/prisma/client";
...
import type {
  ...
  CreateCompanyProductEntity,
} from "@/modules/company-session/domain/repositories/company-session.repository";

export class InMemoryCompanySessionRepository implements CompanySessionRepository {
  ...
  async addProducts(props: CreateCompanyProductEntity): Promise<void> {}
